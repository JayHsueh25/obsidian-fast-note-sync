...
export default {
  ...
  "setting.debug.clear_hash_desc": "確認要重建本地雜湊表嗎？\n\n此操作將清理本地檔案雜湊映射表，不影響物理檔案。\n點擊後將立即觸發重建，可能產生短暫卡頓。",
  "setting.debug.clear_time_success": "本地同步時間清理完畢",
  "setting.debug.clear_cache_desc": "清理本地所有類型的同步時間記錄和本地文件哈希映射表，不影響遠端數據和本地物理文件。下次同步將進行全量比對並重新計算。",
  "setting.debug.clear_cache_confirm": "確認要清理同步緩存嗎？\n\n此操作將清理本地所有類型的同步時間記錄和本地文件哈希映射表，不影響遠端數據和本地物理文件。\n下次同步將進行全量比對並重新計算。",
  "setting.debug.clear_cache_success": "同步緩存清理完畢",
  ...
  "ui.log.action.FolderSyncEnd_full": "資料夾同步預估(全量)",
  "ui.log.action.FolderSyncEnd_incremental": "資料夾同步預估(增量)",
  ...
  "ui.log.action.NoteSyncEnd_full": "筆記同步預估(全量)",
  "ui.log.action.NoteSyncEnd_incremental": "筆記同步預估(增量)",
  ...
  "ui.log.action.FileSyncEnd_full": "附件同步預估(全量)",
  "ui.log.action.FileSyncEnd_incremental": "附件同步預估(增量)",
  ...
  "ui.log.action.SettingSyncEnd_full": "設定同步預估(全量)",
  "ui.log.action.SettingSyncEnd_incremental": "設定同步預估(增量)",
