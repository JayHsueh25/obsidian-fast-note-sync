...
export default {
  ...
  "setting.debug.clear_hash_desc": "Are you sure you want to rebuild the local hash table?\n\nThis will clear the local file hash mapping table. Physical files are unaffected.\nClicking will immediately trigger a rebuild, which may cause brief lag.",
  "setting.debug.clear_time_success": "Local sync time cleared",
  "setting.debug.clear_cache_desc": "Clear local sync record timestamps and file hash mappings. Remote data and local physical files are unaffected. The next sync will perform a full comparison and recalculate hashes.",
  "setting.debug.clear_cache_confirm": "Are you sure you want to clear the sync cache?\n\nThis will clear local sync record timestamps and file hash mappings. Remote data and local physical files are unaffected.\nThe next sync will perform a full comparison and recalculate hashes.",
  "setting.debug.clear_cache_success": "Sync cache cleared successfully",
  ...
  "ui.log.action.FolderSyncEnd_full": "Folder sync estimate (full)",
  "ui.log.action.FolderSyncEnd_incremental": "Folder sync estimate (incremental)",
  ...
  "ui.log.action.NoteSyncEnd_full": "Note sync estimate (full)",
  "ui.log.action.NoteSyncEnd_incremental": "Note sync estimate (incremental)",
  ...
  "ui.log.action.FileSyncEnd_full": "Attachment sync estimate (full)",
  "ui.log.action.FileSyncEnd_incremental": "Attachment sync estimate (incremental)",
  ...
  "ui.log.action.SettingSyncEnd_full": "Settings sync estimate (full)",
  "ui.log.action.SettingSyncEnd_incremental": "Settings sync estimate (incremental)",
